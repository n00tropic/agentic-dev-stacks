...
| Stack                 | Persona                              | Status     | Supported OSes          | What you get                                                                                                                                                                | How to install                                                                                                                                                                                                                                                                                   |
| --------------------- | ------------------------------------ | ---------- | ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| core-base-dev         | Core / Base Dev                      | Production | macOS / Windows / Linux | Baseline extensions/settings; no MCP by default                                                                                                                             | From repo root: `cd vscode && ./scripts/install-core-base-dev.sh` (PowerShell: `./scripts/Install-CoreBaseDev.ps1`). Opens `vscode/exports/workspaces/core-base-dev/core-base-dev.code-workspace` under the `Core / Base Dev` profile.                                                           |
| fullstack-js-ts       | Full-stack JS/TS – Web & API         | Production | macOS / Windows / Linux | Devcontainer (Node/TypeScript), profile export placeholder to replace after first run, agents: refactor-surgeon, test-writer, doc-surgeon; toolsets: local-dev, review-only | Run OS installer script (e.g. `scripts/install/fullstack-js-ts-macos.sh`). It builds the export, installs extensions into the `Fullstack JS/TS – Web & API` profile, and opens the workspace. Optionally import `vscode/profiles-dist/fullstack-js-ts.code-profile` once you have a real export. |
| python-data-analytics | Data/ML/analytics engineers (Python) | Beta       | macOS / Windows / Linux | Devcontainer (Python), profile export placeholder to replace after first run, agents: data-explorer, pipeline-refactorer, doc-surgeon; toolsets: local-dev, review-only     | Run OS installer script (e.g. `scripts/install/python-data-analytics-macos.sh`). It builds the export, installs extensions into the profile, and opens the workspace. Optionally import `vscode/profiles-dist/python-data-analytics.code-profile` once you have a real export.                   |
| infra-ops-sre         | Infra/Platform/SRE engineers         | Beta       | macOS / Windows / Linux | Devcontainer (infra tooling), profile export placeholder to replace after first run, agents: infra-reviewer, incident-scribe, doc-surgeon; toolsets: review-only            | Run OS installer script (e.g. `scripts/install/infra-ops-sre-macos.sh`). It builds the export, installs extensions into the profile, and opens the workspace. Optionally import `vscode/profiles-dist/infra-ops-sre.code-profile` once you have a real export.                                   |
