...
- **`prompts/`** – prompt packs for Copilot/sub-agents (copy into workspaces as needed).
...
- Use prompt packs in `prompts/packs/` to keep Copilot/custom agents aligned (en-GB spellings, safety notes).
