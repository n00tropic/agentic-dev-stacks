...
# Profiles in this pack: infra-devops, data-db-analytics, linux-ci-headless
...
declare -A PROFILES=(
  ["infra-devops"]="Infra & DevOps (Docker/K8s/Terraform)"
  ["data-db-analytics"]="Data / DB & Analytics"
  ["linux-ci-headless"]="Linux – CI/Headless"
)
