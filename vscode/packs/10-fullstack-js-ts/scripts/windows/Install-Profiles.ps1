...
# Profiles in this pack: fullstack-js-ts, frontend-ux-ui, node-backend-services, desktop-gui-cross
...
$Profiles = @{
  "fullstack-js-ts" = "Fullstack JS/TS – Web & API"
  "frontend-ux-ui" = "Frontend UX/UI – React / Storybook / DX"
  "node-backend-services" = "Node / Backend Services – TS/Node"
  "desktop-gui-cross" = "Desktop & GUI – Swift / TS / Python"
}
