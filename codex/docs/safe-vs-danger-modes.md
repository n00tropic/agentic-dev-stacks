# Safe vs Danger Modes for MCP Servers

## Overview

MCP servers can operate in different modes with varying levels of access and capabilities.
...
<!-- TODO: Add specific TOML configuration examples for each mode -->

## Privacy Considerations

Some MCP servers have `privacy_sensitive = true` flags in their manifests. Review these carefully:

<!-- TODO: Document privacy-sensitive MCP servers and their implications -->
